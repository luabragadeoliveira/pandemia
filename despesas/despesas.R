...
ggplot(eb_uf_compras) +
  ...
  labs(title = "Total de compras realizadas pelo Exército Brasileiro por estado",
...
ggplot(eb_uf_gastos) +
  ...
  annotation_north_arrow (location = "tr", 
                          style = north_arrow_nautical()) + #insere orientação ("tr" = top right = canto direito superior)
  labs(title = "Despesas do Exército Brasileiro por estado",
       subtitle = "Houve maior concentração de despesas nos estados do Amazonas e do Distrito Federal",
       x = "",
       y = "",
       caption = "") +
  theme_void() +
...
ggplot(mb_uf_gastos) +
  ...
  labs(title = "Despesas da Marinha do Brasil por estado",
       subtitle = "Houve maior concentração de despesas no estado do Rio de Janeiro",
       x = "",
       y = "",
       caption = "") +
  theme_void() +
...
ggplot(fab_uf_compras) +
  ...
  annotation_north_arrow (location = "tr", 
                          style = north_arrow_nautical()) + #insere orientação ("tr" = top right = canto direito superior)
  labs(title = "Total de compras realizadas pela Força Aérea Brasileira por estado",
...
ggplot(fab_uf_gastos) +
  ...
  annotation_north_arrow (location = "tr", 
                          style = north_arrow_nautical()) + #insere orientação ("tr" = top right = canto direito superior)
  labs(title = "Despesas da Força Aérea Brasileira por estado",
       subtitle = "Houve maior concentração de despesas no estado do Rio de Janeiro",
       x = "",
       y = "",
       caption = "") +
